        ...
        <div class="section-title">
            <table class="Block" style="width: 100%">
                <tr>
                    ...
                    <td class="Block">Room No:A32</td>
                    <td class="Block">Room No:A33</td>
                    <td class="Block" rowspan="4">A BLOCK</td>
                    <td class="Block">Room No:A34</td>
                    <td class="Block">Room No:A35</td>
                    <td class="Block">Room No:A36</td>
                </tr>
                <tr>
                    <td class="Block">Room No:A21</td>
                    <td class="Block">Room No:A22</td>
                    <td class="Block">Room No:A23</td>
                    <td class="Block">Room No:A24</td>
                    <td class="Block">Room No:A25</td>
                    <td class="Block">Room No:A26</td>
                </tr>
                <tr>
                    <td class="Block" colspan="3">Library</td>
                    <td class="Block" colspan="3">Computer Lab</td>
                </tr>
                <tr>
                    <td class="Block" colspan="3">TNP Cell</td>
                    <td class="Block" colspan="3">Laboratory</td>
                </tr>
            </table>
...
?>
        ...
        <div>
          <a href="Rooms/RoomNo-A31.php"><button>Allot 60 Students</button></a>
        </div>
        </main>
