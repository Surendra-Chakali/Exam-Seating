...
while ($result = mysqli_fetch_assoc($sql)) {
  ...
  if ($i <= 30) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A31', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 60) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A32', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 90) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A33', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 120) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A34', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
    elseif ($i <= 150) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A35', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 180) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A36', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 210) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A21', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 240) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A22', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 270) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A23', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 300) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A24', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
    elseif ($i <= 330) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A25', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 360) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'A26', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 390) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'library', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
      elseif ($i <= 420) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'computerLab', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 450) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'TNPcell', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  elseif ($i <= 480) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'laboratory', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
  }
  else{
    echo "<script>alert('A-Block is full');</script>";
  }
